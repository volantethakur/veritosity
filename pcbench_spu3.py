...
def generate_multiple_mandelbrot_cpu(regions, max_iter):
    ...
    # Explicitly set the number of processes to match the number of CPU cores
    ...
    with Pool(processes=num_processes) as pool:
        ...
        results = list(tqdm(pool.imap_unordered(compute_mandelbrot_region, regions_with_iter), total=len(regions)))
